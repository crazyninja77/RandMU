...
const EN: Dict = {
  ...
  "card.origin": "Where it's from · {country}",
  ...
  "rate.help": "Drag the slider and let go to see what everyone else thinks.",
...
const NL: Dict = {
  ...
  "card.origin": "Waar het vandaan komt · {country}",
  ...
  "rate.help": "Sleep de schuif en laat los om te zien wat de rest vindt.",
